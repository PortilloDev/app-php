...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      <div class="col-3">
        <img id="profile-picture" src="https://ui-avatars.com/api/?name=Ivan+Portillo&size=255" alt="">
      </div>
      <div class="col">
        <h1><?php echo $name; ?></h1>
        <h2>PHP Developer</h2>
        <ul>
          ...
          <li>LinkedIn: <a href="<?php $linkedin_username; ?>"> www.linkedin.com </a> </li>
          <li>Twitter:<?php echo $twitter_username; ?></li>
          <li>Web: <?php echo $web_personal; ?></li>
